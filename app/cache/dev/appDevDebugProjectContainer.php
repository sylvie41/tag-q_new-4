...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/QuetesymfonyBundle/Resources/config/doctrine') => 'QuetesymfonyBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('QuetesymfonyBundle' => 'QuetesymfonyBundle\\Entity'));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('587ce59ae99e33.39698133')), true);
